...
User class from Exercise 9-3 (page 166) . Write a method called increment_
...
print(user1.login_attempts)  # should be 3

user1.reset_login_attempts()
print(user1.login_attempts)  # should be 0